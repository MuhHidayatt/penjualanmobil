...
if ($result_sales->num_rows > 0) {
    ...
    $total_sales = isset($row_sales['total_sales']) ? $row_sales['total_sales'] : 0;
    $total_orders = isset($row_sales['total_orders']) ? $row_sales['total_orders'] : 0;
}
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="" class="row g-3 mb-4">
                                        ...
                                        <div class="col-md-3 align-self-end">
                                            ...
                                            <button type="submit" formaction="report_sale.php" target="blank" class="btn btn-primary">Cetak</button>
                                        </div>
                                    </form>
